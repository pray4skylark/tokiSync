# Graph Report - tokiSync  (2026-05-31)

## Corpus Check
- 147 files · ~190,051 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2932 nodes · 6756 edges · 161 communities (136 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 164 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2bb2f16f`
...
Cohesion: 0.02
Nodes (125): _0, a0, ab, Ah, av, ay, _b, b0 (+117 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (32): am, bm, cd(), cm, ed, fd(), fm, gm (+24 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (86): addKeys(), Ae, ag(), Ai(), as(), bf, bg, bl() (+78 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (60): a, activeWorkers, addEpisodesToQueue(), apply(), arrayBufferToBase64(), blob, builder, checkInterval (+52 more)
...
Cohesion: 0.08
Nodes (67): ba(), di(), Dn(), Do(), du(), $e(), Ee(), eu() (+59 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (64): _a(), An(), Ar(), Be(), bn(), ca(), Cc, Ce() (+56 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (46): Ad(), au(), bh(), cn(), Ct(), dd(), ef, ei (+38 more)
...
Cohesion: 0.05
Nodes (25): aa(), da(), Ea(), fa(), fc(), fl(), Gc(), getDatabaseNames() (+17 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (40): ac(), add(), addKey(), Ap(), Bc(), bp(), dp, El (+32 more)

### Community 13 - "Community 13"
Cohesion: 0.1
Nodes (40): isAudioRunning(), startSilentAudio(), stopSilentAudio(), getConfig(), isConfigValid(), setConfig(), showConfigModal(), detectSite() (+32 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (46): Ao(), at, Co(), cr, cs(), eh(), fi(), ga() (+38 more)
...
Cohesion: 0.08
Nodes (23): EpubBuilder, extractEpisodeData(), blob, config, originalConsole, result, url, registerIpcListener() (+15 more)
...
Cohesion: 0.12
Nodes (32): checkInjection(), checkSingleHistoryDirect(), clearHandshakeTimeout(), closeActivePopup(), closeActiveWorker(), fetchComicImages(), fetchHistory(), fetchHistoryDirect() (+24 more)

### Community 23 - "Community 23"
Cohesion: 0.1
Nodes (37): af, Al, bd(), Bi(), Bo, Bs(), bt(), _d() (+29 more)

### Community 24 - "Community 24"
Cohesion: 0.1
Nodes (22): fetchImages(), generateDownloadReport(), get(), getImageDimensions(), getQueueItemId(), initQueueScheduler(), initWorkerLogBox(), LogBox (+14 more)
...
Cohesion: 0.1
Nodes (31): 1. 📡 GAS 서버 배포, 2. 📥 UserScript (수집기) 설치, 3. 📊 뷰어 실행, ⚡️ TokiSync (토끼싱크) v1.10.0, ⚡️ TokiSync (토끼싱크) v1.20.5, ⚡️ TokiSync (토끼싱크) v1.8.3, ⚡️ TokiSync (토끼싱크) v1.9.41, ⚡️ TokiSync (토끼싱크) v1.9.5 (+23 more)
...
Cohesion: 0.08
Nodes (27): 1-1. 프로젝트 생성 및 코드 복사, 1-2. appsscript.json 매니페스트 설정 (중요), 1-2. Drive API v3 서비스 활성화 (매우 중요), 1-3. 🔒 보안(API Key) 및 배포, 1-3. 🔒 보안(API Key) 설정, 1-4. 🚀 웹 앱 새 배포 (New Deployment), 🌐 ① 브라우저 팝업 차단 완전 해제 (필수), 1단계: Google Apps Script (서버) 설정 (+19 more)
...
Cohesion: 0.22
Nodes (23): addEpisodesToQueue(), clearQueue(), closedCounts, getQueue(), getQueueItemId(), getQueuePaused(), getQueueStats(), getRawQueue() (+15 more)
...
Cohesion: 0.1
Nodes (21): Changelog, 🐛 GAS 번들 빌더 누락 핫픽스 (DriveAccessService 해결), ✨ Kavita 호환성 강화 및 배치 다운로드 시스템, 🛠 Technical Details (v1.6.0), [v1.10.0] - 2026-05-18, [v1.1.3] - 2026-01-XX, [v1.20.6] - 2026-05-28, [v1.6.0] - 2026-03-15 (+13 more)
...
Cohesion: 0.18
Nodes (12): bridge, ScriptBridge, b64urlDecode(), b64urlEncode(), getIdsFromUrl(), getNvCookie(), getValidNonce(), hmacSign() (+4 more)

### Community 50 - "Community 50"
Cohesion: 0.17
Nodes (12): TokiApiClient, b64urlDecode(), b64urlEncode(), fetchNovelText(), fetchNovelTextViaApi(), fetchNovelTextViaPopup(), getCookie(), getIdsFromUrl() (+4 more)
...
## Knowledge Gaps
- **848 isolated node(s):** `loaderMajor`, `requiredMajor`, `IGNORE_TAGS`, `KEEP_ATTRS`, `payload` (+843 more)
...
- **Why does `r()` connect `Community 12` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 7`, `Community 11`, `Community 43`, `Community 14`, `Community 50`, `Community 23`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `tokiDownload()` connect `Community 4` to `Community 50`?**
