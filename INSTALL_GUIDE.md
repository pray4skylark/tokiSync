...
4. **동작 확인 및 설정**:
   - 뉴토끼/북토끼 사이트의 작품 상세 페이지에 접속.
     - 소설 새 주소 예: `https://ntk01.com/novel/17709`
     - 전체 소설 목록(`https://ntk01.com/novel`)은 다운로드 대상 페이지가 아니므로, 작품을 하나 선택한 뒤 상세 페이지에서 실행합니다.
...
**Q. 통합 메뉴 창이 안 보여요.**
A. 지원되는 사이트의 작품 상세 페이지에 접속해야 우측 하단 플로팅 버튼과 단축키(`Ctrl+Shift+T`)가 활성화됩니다. 새 뉴토끼 소설은 `https://ntk01.com/novel/{작품ID}` 형식에서 사용하세요.
