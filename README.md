# ⚡️ TokiSync (토끼싱크) v1.23.0

**북토끼, 뉴토끼, 마나토끼**의 콘텐츠를 **구글 드라이브로 직접 업로드**하고, **전용 웹 뷰어**를 통해 편리하게 관리/열람할 수 있는 올인원 솔루션입니다.

> **🚀 v1.23.0 업데이트 요약:**
> - **가변 배율 속도 정책 도입**: 딜레이 배율(Multiplier)을 통해 첫 통신, 가상 스크롤, 폴링 주기, 이동 지터를 한 번에 유기적으로 조율합니다.
> - **큐 스토리지 경쟁 조건 해소**: 자식 워커의 직접 스토리지 쓰기를 걷어내고 부모 단일 채널로 큐 쓰기 권한을 일원화하여 완료 이력이 롤백되던 결함을 차단했습니다.

---

## ✨ 주요 기능

### 📥 수집기 (UserScript) - v1.23.0
