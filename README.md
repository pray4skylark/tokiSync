# ⚡️ TokiSync (토끼싱크) v1.21.3

**북토끼, 뉴토끼, 마나토끼**의 콘텐츠를 **구글 드라이브로 직접 업로드**하고, **전용 웹 뷰어**를 통해 편리하게 관리/열람할 수 있는 올인원 솔루션입니다.

> **🚀 v1.21.3 업데이트 요약:**
> - **차세대 자율형 멀티큐 배치 수집기**: 브라우저 팝업을 이용한 은밀하고 안전한 병렬 파싱 처리와 IPC 통신 엔진을 완전히 안착시켰습니다.
> - **독립형 풀스크린 대시보드 리디자인**: 웹페이지 임베드용 껍데기(마진, 둥근 모서리, 그림자)를 완전히 걷어내고 팝업창 전체를 활용하는 시원한 레이아웃을 구축했습니다.
> - **로그 시인성 극대화 및 스크롤 해결**: 일반 디버그 로그의 브라우저 콘솔 분배 필터링과 info 격상 레벨을 적용하고, 내부 다크 패널 및 250px 영역 한계를 명시해 내부 스크롤바 작동을 완벽히 교정했습니다.
> - **초고도 스텔스 섀도 DOM 우회 엔진 이식**: hasOwnProperty, Function.prototype.toString, iframe contentWindow 비교 검사까지 완벽히 차단·교란하는 섀도 DOM 강제 개방 훅을 완수하여 소설 수집 기능을 안전하게 정상 복구했습니다.

---

## ✨ 주요 기능

### 📥 수집기 (UserScript) - v1.21.3
...
### 📊 뷰어 2.0 (Cinematic & Refined) - v1.21.3
