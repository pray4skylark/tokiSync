...
새 뉴토끼 소설 주소(`ntkXX.com/novel/{작품ID}`)도 소설 수집 대상으로 지원합니다.
...
1. 웹툰/소설 작품 상세 페이지에 접속합니다.
   - 예: `https://ntk01.com/novel/17709`
   - `https://ntk01.com/novel` 같은 전체 소설 목록 페이지에서는 다운로드 메뉴가 활성화되지 않습니다.
