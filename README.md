# ⚡️ TokiSync (토끼싱크) v1.20.5

**북토끼, 뉴토끼, 마나토끼**의 콘텐츠를 **구글 드라이브로 직접 업로드**하고, **전용 웹 뷰어**를 통해 편리하게 관리/열람할 수 있는 올인원 솔루션입니다.

> **🚀 v1.20.5 업데이트 요약:**
> - **팝업 50x400 최적화 및 3회 재시도 자동화**: 극슬림 팝업 차단 및 봇 감지 우회를 위해 안정 규격(500x800) 절충안 및 3회 자동 재시도 래퍼를 도입하여 수집 안정성을 획기적으로 향상시켰습니다.
> - **가이드북 대대적 개편**: Cloudflare 등 5대 보안 장벽 우회 설정을 보완한 통합 설치 가이드를 제공합니다.
